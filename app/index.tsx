  ...
  return (
    <View style={styles.container}>
      ...
      <HomePageCard
        ...
        description="Ինչպես իրական քննությունը, այս թեստային հարցաշարը ևս պարունակում է 10 պատահական հարց: Անցողիկ շեմը 80% է, այսինքն՝ թույլատրվում է միայն 2 սխալ պատասխան։"
